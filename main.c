...
float A2[] = {1 , -2.2184 , 1.7132 , -0.4530 };
float B2[] = { 0 , 0.0085 , 0.0276 , 0.0057 };
int N2 = 3;
/* USER CODE END PV */
...
{
  //The y histories are already pre-shifted;indexes are adjusted accordingly
	//N and M are same which is Nf
	float fout = 0;

	    for (uint32_t r = 0; r <= Nf; r++) {
